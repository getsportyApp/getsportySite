    ...
    //    console.log(JSON.stringify(data));
      //  data.sort(sortByProperty('date_diff'));
        ...
        if(data[i]['image']!='')
        {
            if (i==1)
            {
            event_temp +='<div class="carousel-item active" ><div class="container-fluid pd0"><div class="row"><div class="col-md-4" style="margin-top:20px;" ><div class="card" style="height:500px;" ><img class="img-fluid" src="'+image_path+data[i]['image']+'" alt="img"><div class="card-block"><h4 class="card-title">'+name+'</h4><span style="float:left;" class="label label-success">'+ startdate +'</span><span style="float:right;" class="label label-warning">'+ enddate +'</span><br><span style="float:left;" class="label label-success">'+ entrydate +'</span><span style="float:right;" class="label label-warning">'+ entryenddate +'</span><br><i class="fa fa-location-arrow" style="float: left;"  aria-hidden="true">'+location+'</i><i class="fa fa-futbol-o" style="float: right;" aria-hidden="true"> '+ sport +' </i><br><div><p class="card-text">'+ description +'...</p></div><div class="bottombutton" style="bottom:6px;"><a href="'+url+'"  class="btn btn-primary" target="_blank">View</a></div></div></div></div>';
            }
            else
            {
            if(i%3==0)
            {
                event_temp +='<div class="col-md-4" style="margin-top:20px;" ><div class="card" style="height:500px;"><img class="img-fluid" src="'+image_path+data[i]['image']+'" alt="img"><div class="card-block"><h4 class="card-title">'+name+'</h4><span style="float:left;" class="label label-success">'+ startdate +'</span><span style="float:right;" class="label label-warning">'+ enddate +'</span><br><span style="float:left;" class="label label-success">'+ entrydate +'</span><span style="float:right;" class="label label-warning">'+ entryenddate +'</span><br><i class="fa fa-location-arrow" style="float: left;"  aria-hidden="true">'+location+'</i><i class="fa fa-futbol-o" style="float: right;" aria-hidden="true"> '+ sport +' </i><br><div><p class="card-text">'+description+'...</p></div><div class="bottombutton" style="bottom:6px;"><a href="'+url+'"  class="btn btn-primary" target="_blank">View</a></div></div></div></div></div></div></div><div class="carousel-item"><div class="container-fluid pd0"><div class="row">';   
            }
            else
            {
            event_temp +='<div class="col-md-4" style="margin-top:20px;"><div class="card" style="height:500px;" ><img class="img-fluid" src="'+image_path+data[i]['image']+'" alt="img"><div class="card-block"><h4 class="card-title">'+name+'</h4><span style="float:left;" class="label label-success">'+ startdate +'</span><span style="float:right;" class="label label-warning">'+ enddate +'</span><br><span style="float:left;" class="label label-success">'+ entrydate +'</span><span style="float:right;" class="label label-warning">'+ entryenddate +'</span><br><i class="fa fa-location-arrow" style="float: left;"  aria-hidden="true">'+location+'</i><i class="fa fa-futbol-o" style="float: right;" aria-hidden="true"> '+ sport +' </i><br><div><p class="card-text">'+description+'...</p></div><div class="bottombutton" style="bottom:6px;"><a href="'+url+'"  class="btn btn-primary" target="_blank">View</a></div></div></div></div>'; 
